...
namespace Oip.Discussions.Base.Data.Migrations.Postgres
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false, comment: "Content of the comment."),
                    UserId = table.Column<long>(type: "bigint", nullable: false, comment: "Identifier of the user who created the comment."),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Date and time when the comment was created."),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true, comment: "Date and time when the comment was last updated."),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true, comment: "Date and time when the comment was deleted."),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false, comment: "Indicates whether the comment is deleted.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false, comment: "Original name of the attached file."),
                    FilePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "Physical path to the attached file in storage."),
                    FileType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "MIME type or file extension of the attachment."),
                    FileSize = table.Column<long>(type: "bigint", nullable: false, comment: "Size of the attached file in bytes."),
                    UploadedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Date and time when the attachment was uploaded."),
                    StorageFileId = table.Column<Guid>(type: "uuid", nullable: false, comment: "Unique identifier for the file in the storage system.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldContent = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false, comment: "The content of the comment before the edit."),
                    NewContent = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false, comment: "The content of the comment after the edit."),
                    EditedByUserId = table.Column<long>(type: "bigint", nullable: false, comment: "Identifier of the user who performed the edit."),
                    EditedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Date and time when the edit was performed."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommentEditHistory_Comment_CommentEntityObjectTypeId_Commen~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Position = table.Column<int>(type: "integer", nullable: false, comment: "Position of the mention within the comment text."),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Date and time when the mention was created."),
                    CommentEntityCommentId = table.Column<long>(type: "bigint", nullable: true),
                    CommentEntityObjectId = table.Column<long>(type: "bigint", nullable: true),
                    CommentEntityObjectTypeId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mention_Comment_CommentEntityObjectTypeId_CommentEntityObje~",
                        columns: x => new { x.CommentEntityObjectTypeId, x.CommentEntityObjectId, x.CommentEntityCommentId },
                        principalSchema: "discussions",
                        principalTable: "Comment",
                        principalColumns: new[] { "ObjectTypeId", "ObjectId", "CommentId" });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmojiCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, comment: "Emoji code representing the reaction type (e.g., Like, Heart, etc.)."),
                    ReactedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Timestamp when the reaction was created.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentEditHistory_CommentEntityObjectTypeId_CommentEntityO~",
                schema: "discussions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mention_CommentEntityObjectTypeId_CommentEntityObjectId_Com~",
                schema: "discussions",
                table: "Mention",
                columns: new[] { "CommentEntityObjectTypeId", "CommentEntityObjectId", "CommentEntityCommentId" });
