    ...
    public partial class Init_Postgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationChannelId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the notification channel")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "Name of the notification channel"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "Whether the channel is active"),
                    RequiresVerification = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false, comment: "Whether the channel requires user verification"),
                    MaxRetryCount = table.Column<int>(type: "integer", nullable: true, comment: "Maximum number of delivery retry attempts")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationTypeId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the notification type")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "Name of the notification type"),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true, comment: "Detailed explanation of the notification type"),
                    Scope = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, comment: "Scope of notification type (global, appName, feature)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationId = table.Column<long>(type: "bigint", nullable: false, comment: "Unique identifier for the notification")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NotificationTypeId = table.Column<int>(type: "integer", nullable: false, comment: "Notification type identifier"),
                    Importance = table.Column<int>(type: "integer", nullable: false, comment: "Importance level of the notification"),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Creation timestamp of the notification"),
                    DataJson = table.Column<string>(type: "text", nullable: true, comment: "JSON data associated with the notification")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationTemplateId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the notification template")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NotificationTypeId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the notification type"),
                    SubjectTemplate = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false, comment: "Subject template for the notification"),
                    MessageTemplate = table.Column<string>(type: "text", nullable: false, comment: "Message template for the notification"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "Whether the notification template is currently active"),
                    NotificationChannelEntityNotificationChannelId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationTemplate", x => x.NotificationTemplateId);
                    table.ForeignKey(
                        name: "FK_NotificationTemplate_NotificationChannel_NotificationChanne~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserNotificationPreferenceId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the user notification preference")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false, comment: "User identifier"),
                    NotificationTypeId = table.Column<int>(type: "integer", nullable: false, comment: "Notification type identifier"),
                    NotificationChannelId = table.Column<int>(type: "integer", nullable: false, comment: "Notification channel identifier"),
                    IsEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "Whether notifications are enabled for this preference")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNotificationPreference", x => x.UserNotificationPreferenceId);
                    table.ForeignKey(
                        name: "FK_UserNotificationPreference_NotificationChannel_Notification~",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserNotificationPreference_NotificationType_NotificationTyp~",
                        column: x => x.NotificationTypeId,
                        principalSchema: "notifications",
                        principalTable: "NotificationType",
                        principalColumn: "NotificationTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false, comment: "User identifier"),
                    Subject = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false, comment: "Subject of the notification for this user"),
                    Message = table.Column<string>(type: "text", nullable: false, comment: "Message of the notification for this user")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationTemplateChannelId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the template-channel association")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NotificationTemplateId = table.Column<int>(type: "integer", nullable: false, comment: "Notification template identifier"),
                    NotificationChannelId = table.Column<int>(type: "integer", nullable: false, comment: "Notification channel identifier")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationTemplateChannel_NotificationChannel_Notificatio~",
                        column: x => x.NotificationChannelId,
                        principalSchema: "notifications",
                        principalTable: "NotificationChannel",
                        principalColumn: "NotificationChannelId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationTemplateChannel_NotificationTemplate_Notificati~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationTemplateUserId = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the template-user mapping")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NotificationTemplateId = table.Column<int>(type: "integer", nullable: false, comment: "Notification template identifier"),
                    UserId = table.Column<int>(type: "integer", nullable: false, comment: "User identifier")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationTemplateUser_NotificationTemplate_NotificationT~",
                        column: x => x.NotificationTemplateId,
                        principalSchema: "notifications",
                        principalTable: "NotificationTemplate",
                        principalColumn: "NotificationTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false, comment: "User identifier"),
                    NotificationChannelId = table.Column<int>(type: "integer", nullable: false, comment: "Notification channel identifier"),
                    Status = table.Column<int>(type: "integer", nullable: false, defaultValue: 0, comment: "Delivery status"),
                    ExternalId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true, comment: "External identifier from the delivery service"),
                    ErrorMessage = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true, comment: "Error message if delivery failed"),
                    RetryCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0, comment: "Number of delivery retry attempts"),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "Creation timestamp of the delivery record"),
                    SentAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true, comment: "Timestamp when the notification was sent"),
                    DeliveredAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true, comment: "Timestamp when the notification was delivered")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationDelivery", x => x.NotificationDeliveryId);
                    table.ForeignKey(
                        name: "FK_NotificationDelivery_NotificationChannel_NotificationChanne~",
                        column: x => x.NotificationChannelId,
                        principalSchema: "notifications",
                        principalTable: "NotificationChannel",
                        principalColumn: "NotificationChannelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTemplate_NotificationChannelEntityNotificationC~",
                schema: "notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTemplateChannel_NotificationTemplateId_Notifica~",
                schema: "notifications",
                table: "NotificationTemplateChannel",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationPreference_UserId_NotificationTypeId_Notifi~",
                schema: "notifications",
                table: "UserNotificationPreference",
