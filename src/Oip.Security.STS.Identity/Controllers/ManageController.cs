    ...
    where TKey : IEquatable<TKey>
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (user == null) return NotFound(_localizer["UserNotFound", _userManager.GetUserId(User)]);
    ...
    public async Task<IActionResult> Index(IndexViewModel model)
    {
        ...
        if (model.Email != email)
        {
            ...
            if (!setEmailResult.Succeeded) throw new ApplicationException(_localizer["ErrorSettingEmail", user.Id]);
        }
        ...
        if (model.PhoneNumber != phoneNumber)
        {
            ...
            if (!setPhoneResult.Succeeded) throw new ApplicationException(_localizer["ErrorSettingPhone", user.Id]);
        }
    ...
    public async Task<IActionResult> DeletePersonalData(DeletePersonalDataViewModel deletePersonalDataViewModel)
    {
        ...
        if (!result.Succeeded) throw new InvalidOperationException(_localizer["ErrorDeletingUser", user.Id]);
    ...
    public async Task<IActionResult> RemoveLogin(RemoveLoginViewModel model)
    {
        ...
        if (!result.Succeeded) throw new ApplicationException(_localizer["ErrorRemovingExternalLogin", user.Id]);
    ...
    public async Task<IActionResult> LinkLoginCallback()
    {
        ...
        if (info == null) throw new ApplicationException(_localizer["ErrorLoadingExternalLogin", user.Id]);
    ...
    public async Task<IActionResult> Disable2faWarning()
    {
        ...
        if (!user.TwoFactorEnabled) throw new ApplicationException(_localizer["ErrorDisable2FA", user.Id]);
    ...
    public async Task<IActionResult> Disable2fa()
    {
        ...
        if (!disable2faResult.Succeeded) throw new ApplicationException(_localizer["ErrorDisable2FA", user.Id]);
    ...
    public async Task<IActionResult> GenerateRecoveryCodesWarning()
    {
        ...
        if (!user.TwoFactorEnabled) throw new ApplicationException(_localizer["Error2FANotEnabled", user.Id]);
    ...
    private async Task UpdateUserClaimsAsync(IndexViewModel model, TUser user)
    {
        ...
        foreach (var pair in claimsToReplace) await _userManager.ReplaceClaimAsync(user, pair.Item1, pair.Item2);
    }
