...
public class ClientService : IClientService
{
    ...
    public virtual async Task<int> AddClientAsync(ClientDto client)
    {
        ...
        if (!canInsert)
            throw new UserFriendlyViewException(
                string.Format(ClientServiceResources.ClientExistsValue().Description, client.ClientId),
                ClientServiceResources.ClientExistsKey().Description, client);
    ...
    public virtual async Task<int> UpdateClientAsync(ClientDto client, bool updateClientClaims = false,
        bool updateClientProperties = false)
    {
        ...
        var updated =
            await ClientRepository.UpdateClientAsync(clientEntity, updateClientClaims, updateClientProperties);
    ...
    public virtual async Task<int> CloneClientAsync(ClientCloneDto client)
    {
        ...
        var clonedClientId = await ClientRepository.CloneClientAsync(clientEntity, client.CloneClientCorsOrigins,
            ...
            client.CloneClientScopes, client.CloneClientRedirectUris, client.CloneClientClaims,
            client.CloneClientProperties);
    ...
    public virtual async Task<ClientDto> GetClientAsync(int clientId)
    {
        ...
        if (client == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientDoesNotExist().Description, clientId));
    ...
    public virtual async Task<int> AddClientSecretAsync(ClientSecretsDto clientSecret)
    {
        ...
        await AuditEventLogger.LogEventAsync(new ClientSecretAddedEvent(clientSecret.ClientId, clientSecret.Type,
    ...
    public virtual async Task<int> DeleteClientSecretAsync(ClientSecretsDto clientSecret)
    {
        ...
        await AuditEventLogger.LogEventAsync(new ClientSecretDeletedEvent(clientSecret.ClientId,
    ...
    public virtual async Task<ClientSecretsDto> GetClientSecretsAsync(int clientId, int page = 1, int pageSize = 10)
    {
        ...
        await AuditEventLogger.LogEventAsync(new ClientSecretsRequestedEvent(clientSecretsDto.ClientId,
            clientSecretsDto.ClientSecrets.Select(x => (x.Id, x.Type, x.Expiration)).ToList()));
    ...
    public virtual async Task<ClientSecretsDto> GetClientSecretAsync(int clientSecretId)
    {
        ...
        if (clientSecret == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientSecretDoesNotExist().Description, clientSecretId));

        var clientInfo = await ClientRepository.GetClientIdAsync(clientSecret.Client.Id);
        if (clientInfo.ClientId == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientDoesNotExist().Description, clientSecret.Client.Id));
        ...
        await AuditEventLogger.LogEventAsync(new ClientSecretRequestedEvent(clientSecretsDto.ClientId,
            clientSecretsDto.ClientSecretId, clientSecretsDto.Type, clientSecretsDto.Expiration));
    ...
    public virtual async Task<ClientPropertiesDto> GetClientPropertiesAsync(int clientId, int page = 1,
        int pageSize = 10)
    {
        var clientInfo = await ClientRepository.GetClientIdAsync(clientId);
        if (clientInfo.ClientId == null)
    ...
    public virtual async Task<ClientClaimsDto> GetClientClaimAsync(int clientClaimId)
    {
        ...
        if (clientClaim == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientClaimDoesNotExist().Description, clientClaimId));

        var clientInfo = await ClientRepository.GetClientIdAsync(clientClaim.Client.Id);
        if (clientInfo.ClientId == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientDoesNotExist().Description, clientClaim.Client.Id));
    ...
    public virtual async Task<ClientPropertiesDto> GetClientPropertyAsync(int clientPropertyId)
    {
        ...
        if (clientProperty == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientPropertyDoesNotExist().Description, clientPropertyId));

        var clientInfo = await ClientRepository.GetClientIdAsync(clientProperty.Client.Id);
        if (clientInfo.ClientId == null)
            throw new UserFriendlyErrorPageException(
                string.Format(ClientServiceResources.ClientDoesNotExist().Description, clientProperty.Client.Id));
    ...
    private void HashClientSharedSecret(ClientSecretsDto clientSecret)
    {
        ...
        else if (clientSecret.HashTypeEnum == HashType.Sha512) clientSecret.Value = clientSecret.Value.Sha512();
    }
    ...
    private void PopulateClientRelations(ClientDto client)
    {
        ...
        ComboBoxHelpers.PopulateValuesToList(client.IdentityProviderRestrictionsItems,
        ...
        ComboBoxHelpers.PopulateValuesToList(client.AllowedIdentityTokenSigningAlgorithmsItems,
