...
dotnet ef migrations add "${migration_name}SqlServer" --context SqlServerMigrationContext --project ./../Oip.Data --output-dir Migrations/SqlServer -- --ConnectionString="XpoProvider=MSSqlServer;Server=localhost;Database=oip;uid=sa;Password=" --UseEfCoreProvider=false
