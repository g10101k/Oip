...
@Component({
  ...
  template: `
      ...
      <div class="layout-topbar-logo-container">
        ...
        <a
          class="layout-topbar-logo"
           id="oip-app-topbar-logo-link"
           routerLink="">
          <logo class="mr-2" [height]="'36px'" [width]="'36px'"></logo>
          <span>OIP</span>
        </a>
      </div>
    </div>
    ...
    <p-tabs
      *ngIf="securityService.isAdmin && topBarService.topBarItems.length > 0"
      class="layout-topbar-tabs ml-2"
      [(value)]="topBarService.activeId">
      <p-tablist id="oip-app-topbar-tablist">
    ...
    <div class="layout-topbar-actions">
      ...
      <div class="layout-topbar-menu hidden lg:block">
        <div class="layout-topbar-menu-content">
          ...
          <button class="layout-topbar-action" id="oip-app-topbar-profile-button" routerLink="config">
            <p-avatar
