...
export { moduleAccessGuard, ModuleAccessRouteData } from './services/module-access-guard.service';
export { ModuleInstanceRightsService } from './services/module-instance-rights.service';
