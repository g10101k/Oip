...
import { TagManagementModuleDataService } from "./../../api/TagManagementModule";
...
@Component({
  ...
  template: `
    <div *ngIf="isContent" class="grid grid-cols-12 gap-4">
      ...
      <div *ngIf="selectedTag" class="card col-span-12 xl:col-span-12">
        <div class="p-grid p-formgrid">
          <div class="p-col-12 p-md-6">
            <label for="name">Name</label>
            <input pInputText id="name" [(ngModel)]="selectedTag.name"/>
          </div>

          <div class="p-col-12 p-md-6">
            <label for="valueType">Value Type</label>
            <p-dropdown id="valueType" [options]="valueTypeOptions" [(ngModel)]="selectedTag.valueType"></p-dropdown>
          </div>
          ...
          <div class="p-col-12 p-md-6">
            ...
            <input pInputText id="descriptor" [(ngModel)]="selectedTag.descriptor"/>
          </div>
  ...
  `,
  providers: [TagManagementModuleDataService],
  standalone: true,
  imports: [
    NgIf,
    TableModule,
...
export class TagManagement extends BaseComponent<WeatherSettingsDto> implements OnInit, OnDestroy, Feature {
  ...
  tagManagementModuleDataService = inject(TagManagementModuleDataService);
  tags: TagEntity[] = [];
  ...
  async ngOnInit() {
    ...
    this.tags = (await this.tagManagementModuleDataService.tagManagementGetTagsByFilterList({ filter: '%' })).data;
  }
