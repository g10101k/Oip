...
public static class ClientMock
{
    ...
    public static Faker<Client> ClientFaker(int id, bool generateClaims = false, bool generateProperties = false,
        bool generateSecrets = false)
    {
        var clientFaker = new Faker<Client>()
            ...
            .RuleFor(o => o.AllowedIdentityTokenSigningAlgorithms,
                f => string.Join(",", AllowedSigningAlgorithms().Take(f.Random.Number(1, 5)).ToList()));
    ...
    public static Client GenerateRandomClient(int id, bool generateClaims = false, bool generateProperties = false,
        bool generateSecrets = false)
    {
