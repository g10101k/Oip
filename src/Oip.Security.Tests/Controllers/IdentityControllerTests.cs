...
using Oip.Security.UI.Helpers.Localization;
...
public class IdentityControllerTests
{
    ...
    public async Task DeleteUser()
    {
        ...
        var userId = await dbContext.Users.Where(x => x.UserName == userDto.UserName).Select(x => x.Id)
            .SingleOrDefaultAsync();
        userDto.Id = userId;

        // A user cannot delete own account
        var subjectClaim = new Claim(JwtClaimTypes.Subject, userDto.Id);
        ...
        subjectClaim = new Claim(JwtClaimTypes.Subject, "1");
        ProvideControllerContextWithClaimsPrincipal(controller, subjectClaim);
    ...
    public async Task AddUserClaim()
    {
        ...
        var userClaim = await dbContext.UserClaims.Where(x => x.ClaimValue == userClaimsDto.ClaimValue)
            .SingleOrDefaultAsync();
    ...
    public async Task AddUserRole()
    {
        ...
        var userRole = await dbContext.UserRoles.Where(x => x.RoleId == roleDto.Id && x.UserId == userDto.Id)
            .SingleOrDefaultAsync();
    ...
    public async Task DeleteUserClaim()
    {
        ...
        var newUserClaim = await dbContext.UserClaims.Where(x => x.ClaimValue == userClaimsDto.ClaimValue)
            .SingleOrDefaultAsync();
    ...
    public async Task AddRoleClaim()
    {
        ...
        var roleClaim = await dbContext.RoleClaims.Where(x => x.ClaimValue == roleClaimsDto.ClaimValue)
            .SingleOrDefaultAsync();
    ...
    public async Task DeleteRoleClaim()
    {
        ...
        var newRoleClaim = await dbContext.RoleClaims.Where(x => x.ClaimValue == roleClaimsDto.ClaimValue)
            .SingleOrDefaultAsync();
    ...
    public async Task UserProvidersDelete()
    {
        ...
        var providersDto =
            IdentityDtoMock<string>.GenerateRandomUserProviders(randomProviderKey, randomProviderLogin, userId);
        ...
        var userProvider = await dbContext.UserLogins.Where(x => x.ProviderKey == randomProviderKey)
            .SingleOrDefaultAsync();
    ...
    private IdentityController<UserDto<string>, RoleDto<string>,
            ...
            UserProvidersDto<UserProviderDto<string>, string>, UserChangePasswordDto<string>,
            RoleClaimsDto<RoleClaimDto<string>, string>, UserClaimDto<string>, RoleClaimDto<string>>
        PrepareIdentityController(IServiceProvider serviceProvider)
    {
        // Arrange
        var localizer = serviceProvider
            .GetRequiredService<IGenericControllerLocalizer<IdentityController<UserDto<string>, RoleDto<string>,
                UserIdentity, UserIdentityRole, string, UserIdentityUserClaim, UserIdentityUserRole,
                UserIdentityUserLogin, UserIdentityRoleClaim, UserIdentityUserToken,
        ...
        var controller = new IdentityController<UserDto<string>, RoleDto<string>,
            ...
            UserClaimsDto<UserClaimDto<string>, string>, UserProviderDto<string>,
            UserProvidersDto<UserProviderDto<string>, string>, UserChangePasswordDto<string>,
            RoleClaimsDto<RoleClaimDto<string>, string>, UserClaimDto<string>, RoleClaimDto<string>>(identityService,
            logger, localizer);
    ...
    private IServiceProvider GetServices()
    {
        ...
        services.AddOptions();
        services.AddDbContext<AdminIdentityDbContext>(b =>
