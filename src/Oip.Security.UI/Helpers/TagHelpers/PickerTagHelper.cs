...
namespace Oip.Security.UI.Helpers.TagHelpers;
...
public class PickerTagHelper : TagHelper
{
    ...
    private void AddComponent(TagHelperOutput output)
    {
        ...
        var rawPickerHtml =
            new HtmlString(
                $"<div data-bind='component: {JsonConvert.SerializeObject(component, new JsonSerializerSettings { StringEscapeHandling = StringEscapeHandling.EscapeHtml })}'></div>");
