...
namespace Oip.Security.UI.Helpers.Identity;
...
public class IdentityErrorMessages : IdentityErrorDescriber
{
    ...
    {
        if (TryCreateLocalizedError(nameof(ConcurrencyFailure), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(DefaultError), out var error)) return error;

        return base.DefaultError();
    }

    /// <summary>
    ///     Returns an <see cref="IdentityError" /> indicating the specified <paramref name="email" /> is already associated
    ///     with an account.
    /// </summary>
    /// <param name="email">The email that is already associated with an account.</param>
    /// <returns>
    ///     An <see cref="IdentityError" /> indicating the specified <paramref name="email" /> is already associated with
    ///     an account.
    /// </returns>
    public override IdentityError DuplicateEmail(string email)
    {
        if (TryCreateLocalizedError(nameof(DuplicateEmail), out var error, email)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(DuplicateRoleName), out var error, role)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(DuplicateUserName), out var error, userName)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(InvalidEmail), out var error, email)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(InvalidRoleName), out var error, role)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(InvalidToken), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(InvalidUserName), out var error, userName)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(LoginAlreadyAssociated), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(PasswordMismatch), out var error)) return error;

        return base.PasswordMismatch();
    }

    /// <summary>
    ///     Returns an <see cref="IdentityError" /> indicating a password entered does not contain a numeric character, which
    ///     is required by the password policy.
    /// </summary>
    /// <returns>An <see cref="IdentityError" /> indicating a password entered does not contain a numeric character.</returns>
    public override IdentityError PasswordRequiresDigit()
    {
        if (TryCreateLocalizedError(nameof(PasswordRequiresDigit), out var error)) return error;

        return base.PasswordRequiresDigit();
    }

    /// <summary>
    ///     Returns an <see cref="IdentityError" /> indicating a password entered does not contain a lower case letter, which
    ///     is required by the password policy.
    /// </summary>
    /// <returns>An <see cref="IdentityError" /> indicating a password entered does not contain a lower case letter.</returns>
    public override IdentityError PasswordRequiresLower()
    {
        if (TryCreateLocalizedError(nameof(PasswordRequiresLower), out var error)) return error;

        return base.PasswordRequiresLower();
    }

    /// <summary>
    ///     Returns an <see cref="IdentityError" /> indicating a password entered does not contain a non-alphanumeric
    ...
    {
        if (TryCreateLocalizedError(nameof(PasswordRequiresNonAlphanumeric), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(PasswordRequiresUniqueChars), out var error, uniqueChars)) return error;

        return base.PasswordRequiresUniqueChars(uniqueChars);
    }

    /// <summary>
    ///     Returns an <see cref="IdentityError" /> indicating a password entered does not contain an upper case letter, which
    ///     is required by the password policy.
    /// </summary>
    /// <returns>An <see cref="IdentityError" /> indicating a password entered does not contain an upper case letter.</returns>
    public override IdentityError PasswordRequiresUpper()
    {
        if (TryCreateLocalizedError(nameof(PasswordRequiresUpper), out var error)) return error;

        return base.PasswordRequiresUpper();
    }

    /// <summary>
    ///     Returns an <see cref="IdentityError" /> indicating a password of the specified <paramref name="length" /> does not
    ///     meet the minimum length requirements.
    /// </summary>
    /// <param name="length">The length that is not long enough.</param>
    /// <returns>
    ///     An <see cref="IdentityError" /> indicating a password of the specified <paramref name="length" /> does not
    ///     meet the minimum length requirements.
    /// </returns>
    public override IdentityError PasswordTooShort(int length)
    {
        if (TryCreateLocalizedError(nameof(PasswordTooShort), out var error, length)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(RecoveryCodeRedemptionFailed), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(UserAlreadyHasPassword), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(UserAlreadyInRole), out var error, role)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(UserLockoutNotEnabled), out var error)) return error;
    ...
    {
        if (TryCreateLocalizedError(nameof(UserNotInRole), out var error, role)) return error;

        return base.UserNotInRole(role);
    }

    /// <summary>
    ///     Tries to generate <see cref="IdentityError" /> with <see cref="IdentityError.Code" /> named as
    ///     <paramref name="name" />
    ...
    {
        var description = _stringLocalizer.GetString(name, formatArgs);
