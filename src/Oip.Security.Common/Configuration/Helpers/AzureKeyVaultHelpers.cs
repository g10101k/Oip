...
using Oip.Security.Shared.Configuration.Services;

namespace Oip.Security.Shared.Configuration.Helpers;

public class AzureKeyVaultHelpers
{
    public static async Task<(X509Certificate2 ActiveCertificate, X509Certificate2 SecondaryCertificate)>
        GetCertificates(AzureKeyVaultConfiguration certificateConfiguration)
    {
