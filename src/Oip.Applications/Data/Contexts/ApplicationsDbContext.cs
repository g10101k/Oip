...
namespace Oip.Applications.Data.Contexts;
...
public class ApplicationsDbContext(DbContextOptions<ApplicationsDbContext> options, bool designTime = false)
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder
            .ReplaceService<IMigrationsAssembly,
                BaseContextMigrationAssembly<ApplicationsDbContextSqlServer, ApplicationsDbContextPostgres>>();
...
/// </summary>
public class ApplicationsDbContextSqlServer(DbContextOptions<ApplicationsDbContext> options, bool designTime = true)
    : ApplicationsDbContext(options, designTime);

/// <summary>
/// Represents the PostgreSQL database context for user-related entities.
/// </summary>
public class ApplicationsDbContextPostgres(DbContextOptions<ApplicationsDbContext> options, bool designTime = true)
    : ApplicationsDbContext(options, designTime);
