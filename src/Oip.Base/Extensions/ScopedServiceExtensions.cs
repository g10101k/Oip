...
public static class ScopedServiceExtensions
{
    ...
    public static async Task ExecuteAsync<TService>(this IServiceScopeFactory factory, Func<TService, Task> action) where TService : notnull
    {
    ...
    public static async Task<TResult> ExecuteAsync<TService, TResult>(this IServiceScopeFactory factory, Func<TService, Task<TResult>> action) where TService : notnull
    {
        using var scope = factory.CreateScope();
        var service = scope.ServiceProvider.GetRequiredService<TService>();
