...
using Oip.Security.UI.Areas.AdminUI.Controllers;
...
public class ConfigurationControllerTests
{
    ...
    public async Task GetClients()
    {
        ...
        // Act
        var result = await controller.Clients(1, string.Empty);
    ...
    public async Task GetClientClaim()
    {
        ...
        var result = await controller.ClientClaims(clientId, 1);
        ...
        viewModel.ClientClaims[0].Should().BeEquivalentTo(clientClaimAdded, options => options
    ...
    public async Task DeleteClientClaim()
    {
        ...
        var clientClaimDelete =
            await dbContext.ClientClaims.Where(x => x.Id == clientClaimAdded.Id).SingleOrDefaultAsync();
    ...
    public async Task AddClientSecret()
    {
        ...
        var clientSecretAdded =
            await dbContext.ClientSecrets.Where(x => x.Client.Id == clientId).SingleOrDefaultAsync();
    ...
    public async Task GetClientSecret()
    {
        ...
        var result = await controller.ClientSecrets(clientId, 1);
    ...
    public async Task DeleteClientSecret()
    {
        ...
        var clientSecretDelete =
            await dbContext.ClientSecrets.Where(x => x.Id == clientSecretAdded.Id).SingleOrDefaultAsync();
    ...
    public async Task AddClientProperty()
    {
        ...
        var clientPropertyAdded =
            await dbContext.ClientProperties.Where(x => x.Client.Id == clientId).SingleOrDefaultAsync();
    ...
    public async Task GetClientProperty()
    {
        ...
        var result = await controller.ClientProperties(clientId, 1);
        ...
        viewModel.ClientProperties[0].Should().BeEquivalentTo(clientProperty, options => options
    ...
    public async Task DeleteClientProperty()
    {
        ...
        var newClientProperty = await dbContext.ClientProperties.Where(x => x.Id == clientPropertyAdded.Id)
    ...
    public async Task AddIdentityResource()
    {
        ...
        var identityResource = await dbContext.IdentityResources.Where(x => x.Name == identityResourceDto.Name)
            .SingleOrDefaultAsync();
    ...
    public async Task DeleteIdentityResource()
    {
        ...
        var identityResourceId = await dbContext.IdentityResources.Where(x => x.Name == identityResourceDto.Name)
        ...
        var identityResource = await dbContext.IdentityResources.Where(x => x.Id == identityResourceDto.Id)
            .SingleOrDefaultAsync();
    ...
    public async Task DeleteApiResource()
    {
        ...
        var apiResourceId = await dbContext.ApiResources.Where(x => x.Name == apiResourceDto.Name).Select(x => x.Id)
            .SingleOrDefaultAsync();
    ...
    public async Task DeleteApiScope()
    {
        ...
        var apiScopeId = await dbContext.ApiScopes.Where(x => x.Name == apiScopeDto.Name).Select(x => x.Id)
            .SingleOrDefaultAsync();
    ...
    public async Task AddApiSecret()
    {
        ...
        apiSecretsDto.Should().BeEquivalentTo(addedApiScope,
            opts => opts.Excluding(x => x.ApiResourceId).Excluding(x => x.ApiResourceName).Excluding(x => x.ApiSecretId)
                .Excluding(x => x.Value));
    }
    ...
    private ConfigurationController PrepareConfigurationController(IServiceProvider serviceProvider)
    {
        ...
        //Get Controller
        var controller = new ConfigurationController(identityResourceService, apiResourceService, clientService,
            localizer, logger, apiScopeService);
    ...
    private IServiceProvider GetServices()
    {
        ...
        services.AddOptions();
        services.AddDbContext<IdentityServerConfigurationDbContext>(b =>
        ...
        services
            .AddTransient<IAuditLoggingRepository<AuditLog>,
                AuditLoggingRepository<AdminAuditLogDbContext, AuditLog>>();
        ...
        services
            .AddAdminAspNetIdentityServices<AdminIdentityDbContext, IdentityServerPersistedGrantDbContext,
                UserDto<string>, RoleDto<string>,
