...
public class IdentityDtoMock<TKey>
{
    ...
    public static UserDto<TKey> GenerateRandomUser(TKey id = default)
    {
    ...
    public static RoleDto<TKey> GenerateRandomRole(TKey id = default)
    {
    ...
    public static UserClaimsDto<UserClaimDto<TKey>, TKey> GenerateRandomUserClaim(int id, TKey userId = default)
    {
    ...
    public static Faker<UserProvidersDto<UserProviderDto<TKey>, TKey>> GetUserProvidersFaker(string key,
        string loginProvider, TKey userId)
    {
    ...
    public static UserProvidersDto<UserProviderDto<TKey>, TKey> GenerateRandomUserProviders(string key,
        string loginProvider, TKey userId)
    {
