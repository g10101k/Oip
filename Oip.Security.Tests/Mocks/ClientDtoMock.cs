...
public static class ClientDtoMock
{
    ...
    public static Faker<ClientDto> ClientFaker(int id)
    {
        var clientFaker = new Faker<ClientDto>()
            ...
            .RuleFor(o => o.AccessTokenType, f => f.Random.Number())
            ...
            .RuleFor(o => o.AllowedCorsOrigins,
                f => Enumerable.Range(1, f.Random.Int(1, 10)).Select(x => f.PickRandom(f.Internet.Url())).ToList())
            .RuleFor(o => o.AllowedGrantTypes,
                f => Enumerable.Range(1, f.Random.Int(1, 10)).Select(x => f.PickRandom(ClientConsts.GetGrantTypes()))
                    .ToList())
            .RuleFor(o => o.AllowedScopes,
                f => Enumerable.Range(1, f.Random.Int(1, 10)).Select(x => f.PickRandom(ClientMock.GetScopes()))
                    .ToList())
            ...
            .RuleFor(o => o.RefreshTokenUsage, f => f.Random.Number())
            ...
            .RuleFor(o => o.IdentityProviderRestrictions,
                f => Enumerable.Range(1, f.Random.Int(1, 10))
                    .Select(x => f.PickRandom(ClientMock.GetIdentityProviders())).ToList())
            .RuleFor(o => o.Properties,
                f => new List<ClientPropertyDto>()) //Client Properties are managed with seperate method
            ...
            .RuleFor(o => o.AllowedIdentityTokenSigningAlgorithms,
                f => ClientMock.AllowedSigningAlgorithms().Take(f.Random.Number(1, 5)).ToList());
