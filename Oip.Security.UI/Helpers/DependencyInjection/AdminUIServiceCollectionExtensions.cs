...
public static class AdminUiServiceCollectionExtensions
{
        ...
        where TAuditLog : AuditLog, new()
    {
        return AddIdentityServer4AdminUi<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext,
            ...
            UserChangePasswordDto<string>, RoleClaimsDto<RoleClaimDto<string>, string>, UserClaimDto<string>,
        ...
        where TAuditLog : AuditLog, new()
    {
        return AddIdentityServer4AdminUi<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext,
            ...
            IdentityUserClaim<string>,
            IdentityUserRole<string>, IdentityUserLogin<string>, IdentityRoleClaim<string>,
            IdentityUserToken<string>, string, UserDto<string>, RoleDto<string>, UsersDto<UserDto<string>, string>,
            RolesDto<RoleDto<string>, string>,
            UserRolesDto<RoleDto<string>, string>, UserClaimsDto<UserClaimDto<string>, string>, UserProviderDto<string>,
            UserProvidersDto<UserProviderDto<string>, string>,
            UserChangePasswordDto<string>, RoleClaimsDto<RoleClaimDto<string>, string>, UserClaimDto<string>,
            RoleClaimDto<string>>(services, optionsAction);
        ...
        where TAuditLog : AuditLog, new()
    {
        ...
        if (!options.Testing.IsStaging)
            services.RegisterDbContexts<TIdentityDbContext, TIdentityServerDbContext,
                ...
                TDataProtectionDbContext, TAuditLog>(options.ConnectionStrings, options.DatabaseProvider,
