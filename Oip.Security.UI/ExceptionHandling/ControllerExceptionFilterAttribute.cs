...
public class ControllerExceptionFilterAttribute : ExceptionFilterAttribute
{
    ...
    private void ProcessException(ExceptionContext context, ITempDataDictionary tempData)
    {
        ...
        if (context.Exception is UserFriendlyViewException exception) result.ViewData.Model = exception.Model;
    ...
    protected void CreateNotification(NotificationHelpers.AlertType type, ITempDataDictionary tempData, string message,
        string title = "")
    {
