    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Description = table.Column<string>("varchar(1000) CHARACTER SET utf8mb4", maxLength: 1000,
                    nullable: true),
                Expiration = table.Column<DateTime>("datetime(6)", nullable: true),
                Type = table.Column<string>("varchar(250) CHARACTER SET utf8mb4", maxLength: 250, nullable: false),
                Value = table.Column<string>("longtext CHARACTER SET utf8mb4", maxLength: 4000, nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Type = table.Column<string>("varchar(200) CHARACTER SET utf8mb4", maxLength: 200, nullable: false)
            },
            constraints: table =>
            {
