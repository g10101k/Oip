...
public class RolesController<TUserDto, TRoleDto, TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim,
    TUserToken,
    ...
    where TRoleClaimDto : RoleClaimDto<TKey>
{
    ...
    {
        if (!EqualityComparer<TKey>.Default.Equals(role.Id, default)) return BadRequest(_errorResources.CannotSetId());
    ...
    [HttpGet("{id}/Users")]
    public async Task<ActionResult<TUsersDto>> GetRoleUsers(string id, string searchText, int page = 1,
        int pageSize = 10)
    {
